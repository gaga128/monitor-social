...
def getAPI(urllist):
    #try:
        ...
        for i in range(len(urllist)):
            url=urllist[i]
            t = threading.Thread(target=runs,args=(url,))
            threads.append(t)
...
if __name__=='__main__':
    urllist = ['http://api.data.social-touch.com:8091/cdapi/req?appid=444&passwd=746749378&method=searchTagRes&appkey=172139920&uid=oLceXjgDCcV-SR7TML1IegalxBss&startTime=0&endTime=1447776000&spread=true&tagIds=1,5,7'\
                ...
                ,'http://api.data.social-touch.com:8091/cdapi/req?appid=11&passwd=918672562&method=getLatestTimeOfFansPropertyTagCount&appkey=172139920'\
